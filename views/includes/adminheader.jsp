   ...
   <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
         ...
         <a class="navbar-brand" href="/admin/index">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           현재 시간 : <c:out value="${serverTime }"></c:out>
         </a>
      </div>
      <!-- /.navbar-header -->
      ...
      <div class="navbar-default sidebar" role="navigation">
         <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
               ...
               <li>
                  <a href="#">
                     <i class="fa fa-bar-chart-o fa-fw"></i>상품<span class="fa arrow"></span> 
                  </a>
                  <ul class="nav nav-second-level">
                     <li>
                        <a href="/admin/productRegister">상품 등록</a>
                     </li>
                     <li>
                        <a href="/admin/productList">상품 목록</a>
                     </li>
                  </ul> <!-- /.nav-second-level -->
              </li>
              <li>
                     <a href="/admin/member"><i class="fa fa-table fa-fw"></i>회원</a>
              </li>
              <li>
                     <a href="/admin/adminSignUp"><i class="fa fa-edit fa-fw"></i>관리자 가입</a>
              </li>
              <li>
                     <a href="/admin/manager"><i class="fa fa-table fa-fw"></i>관리자 정보</a>
              </li>
              <li>
                     <a href="#"><i class="fa fa-sitemap fa-fw"></i>통계</a>          
               </li>
               <!-- 통계끝  -->
            </ul>
         </div>
