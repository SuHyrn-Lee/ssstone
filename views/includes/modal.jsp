    		...
    		function showSearchList(p_category1 , keyword) {productservice.getproduct(
   		         {p_category1 : p_category1, keyword : keyword },function(list) {
	   	            ...
	   	            str += "<div class='col position-static'>"
	   	                ...
	   	                +  "<span class='text-muted'>"+numberWithCommas(list[i].p_price)+"원</span></p><strong class= 'pull-right text-muted' style='float:right;'>"+list[i].p_category1+" > "+list[i].p_category2+"</strong></div></div>"
	   	            	+ "<a class='btn btn-link px-0 text-reset' href='/product/shop?p_category1="+p_category1+"&p_category2='><hr></div>";
   		         	}
	    ...
	    <div class="modal fixed-right fade" id="modalShoppingCart" tabindex="-1" role="dialog" aria-hidden="true">
	      <div class="modal-dialog modal-dialog-vertical" role="document">
	        ...
	        <div class="modal-content">
	          ...
	          <!-- Header -->
	          <div class="modal-header line-height-fixed font-size-lg">
	            <strong class="mx-auto">장바구니</strong>
	          </div>
	          <!-- List group -->
	          ...
	          <!-- Buttons -->
	          <div class="modal-body">
	          	  <a class="btn btn-block btn-dark" href="/payment/checkout?m_no=${user_no }">Continue to Checkout</a>
		          <a class="btn btn-block btn-outline-dark" href="/payment/shopcart?m_no=${user_no }">View Cart</a>
	          </div>
	        </div>
